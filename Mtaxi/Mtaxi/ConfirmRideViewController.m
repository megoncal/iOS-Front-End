...
- (void) populateInitialFields{
    ...
    self.pickUpLocation.detailTextLabel.text = self.ride.pickUpAddress.locationName;
    self.dropOffLocation.detailTextLabel.text = self.ride.dropOffAddress.locationName;
