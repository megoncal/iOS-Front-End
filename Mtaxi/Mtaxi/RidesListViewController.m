...
- (IBAction)addRidePressed:(id)sender {
    ...
    //get the viewControllers associated with the navigationController
    NSArray *viewControllers = navigationController.viewControllers;
    
    //get the root view controller
    CreateRideViewController *controller = [viewControllers objectAtIndex:0];
    
    //define self as the implementer of the rootViewController delegate
